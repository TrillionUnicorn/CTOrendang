...
import {
  ...
  wrap_snippet,
  writable
} from "./chunk-WLWNXVML.js";
import "./chunk-U7P2NEEE.js";
import {
  append,
  comment,
  from_html
} from "./chunk-EIC5R7FY.js";
import {
  FILENAME,
  HMR,
  add_svelte_meta,
  ...
  tick,
  untrack
} from "./chunk-KVDG3PD3.js";
import "./chunk-D34P52HZ.js";
import "./chunk-EIJNSXAF.js";
...
function MotionConfig($$anchor, $$props) {
  ...
  legacy_pre_effect(() => (get(transitionDependency), get(config)), () => {
...
function MotionContext_1($$anchor, $$props) {
  ...
  slot(
    ...
    {
      get parent() {
        return $motionContext(), untrack(() => $motionContext().visualElement);
      }
    },
    null
  );
...
function UseVisualElement($$anchor, $$props) {
  ...
  legacy_pre_effect(() => ($layoutGroupId(), deep_read_state(props())), () => {
  ...
  legacy_pre_effect(
    ...
    () => {
      ...
      if (get(visualElement2)) {
        get(visualElement2).setProps({ ...$config(), ...props(), layoutId: get(layoutId) });
...
function UseStyle($$anchor, $$props) {
  ...
  legacy_pre_effect(() => (get(style), get(styleProp), deep_read_state(props())), () => {
  ...
  add_svelte_meta(
    () => UseInitialMotionValues_default(node, {
      ...
      $$slots: {
        default: ($$anchor2, $$slotProps) => {
          ...
          var node_1 = first_child(fragment_1);
          {
            let $0 = derived_safe_equal(() => (deep_read_state(get(s1)), deep_read_state(props()), get(style), untrack(() => toStyle(get(s1), props(), get(style)))));
            slot(
              node_1,
              $$props,
              "default",
    ...
    41,
    0,
    { componentTag: "UseInitialMotionValues" }
  );
  append($$anchor, fragment);
  return pop($$exports);
}
    ...
    () => UseStyle_default(node, {
      ...
      $$slots: {
        default: ($$anchor2, $$slotProps) => {
          ...
          var node_1 = first_child(fragment_1);
          {
            let $0 = derived_safe_equal(() => (deep_read_state(get(styles)), deep_read_state(props()), untrack(() => getHTMLProps(get(styles), props()))));
            slot(
              node_1,
              $$props,
              "default",
      ...
      $$component($$anchor2, {
        ...
        $$slots: {
          default: ($$anchor3, $$slotProps) => {
            ...
            {
              let $0 = derived_safe_equal(() => (get(filteredProps), deep_read_state(get(visualProps)), untrack(() => ({ ...get(filteredProps), ...get(visualProps) }))));
              slot(
                node_2,
                $$props,
                "default",
...
function UseCreateMotionContext($$anchor, $$props) {
  ...
  let tmp = getCurrentTreeVariants(props(), get2(mc)), initial = mutable_source(tmp.initial), animate3 = mutable_source(tmp.animate);
  const variantLabelsAsDependency = (prop2) => {
    return Array.isArray(prop2) ? prop2.join(" ") : prop2;
  };
  const memo = () => {
    return { initial: get(initial), animate: get(animate3) };
  };
  let value = mutable_source(memo());
  legacy_pre_effect(
    () => (get(initial), get(animate3), getCurrentTreeVariants, deep_read_state(props()), $mc()),
    () => {
      (($$value) => {
        set(initial, $$value.initial);
        set(animate3, $$value.animate);
      })(getCurrentTreeVariants(props(), $mc()));
    }
  );
  legacy_pre_effect(
    () => (deep_read_state(isStatic()), get(initial), get(animate3)),
    () => {
      if (isStatic()) {
        set(value, memo(variantLabelsAsDependency(get(initial)), variantLabelsAsDependency(get(animate3))));
      }
    }
  );
  legacy_pre_effect_reset();
...
function makeLatestValues(props, context, presenceContext, scrapeMotionValues) {
  ...
  if (context && isVariantNode && !isControllingVariants && strict_equals(props.inherit, false, false)) {
    ...
    strict_equals(animate3, null, false) && strict_equals(animate3, void 0, false) ? animate3 : animate3 = context.animate;
  }
  const variantToSet = blockInitialAnimation || strict_equals(initial, false) ? animate3 : initial;
...
var root_5 = add_locations(from_html(`<!> <!>`, 1), Motion[FILENAME], []);
function Motion($$anchor, $$props) {
  check_target(new.target);
  const $$sanitized_props = legacy_rest_props($$props, ["children", "$$slots", "$$events", "$$legacy"]);
  const $$restProps = legacy_rest_props($$sanitized_props, ["isSVG", "forwardMotionProps", "externalRef", "targetEl"]);
  push($$props, false, Motion);
  const $a = () => (validate_store(a2, "a"), store_get(a2, "$a", $$stores));
  const [$$stores, $$cleanup] = setup_stores();
  const motionProps = mutable_source();
  const isStatic = mutable_source();
  let isSVG = prop($$props, "isSVG", 8, false), forwardMotionProps = prop($$props, "forwardMotionProps", 8, false), externalRef = prop($$props, "externalRef", 8, void 0), targetEl = prop(
    $$props,
    "targetEl",
    8,
    void 0
  ...
  add_svelte_meta(
    () => ScaleCorrectionProvider_default(node, {
      ...
      children: wrap_snippet(Motion, ($$anchor2, $$slotProps) => {
        ...
        add_svelte_meta(
                          ...
                          () => UseVisualElement_default(node_3, {
                            ...
                            $$slots: {
                              default: ($$anchor5, $$slotProps4) => {
                                ...
                                {
                                  let $0 = derived_safe_equal(() => (deep_read_state(get(context)), deep_read_state(get(visualElement2)), untrack(() => setContext2(get(context), get(visualElement2)))));
                                  add_svelte_meta(
                                          ...
                                          add_svelte_meta(
                                            () => MotionContextProvider_default(node_5, {
                                              ...
                                              children: wrap_snippet(Motion, ($$anchor7, $$slotProps6) => {
                                                ...
                                                {
                                                  let $02 = derived_safe_equal(() => (deep_read_state(useMotionRef), deep_read_state(get(visualState)), deep_read_state(get(context)), deep_read_state(externalRef()), untrack(() => useMotionRef(get(visualState), get(context).visualElement, externalRef()))));
                                                  add_svelte_meta(
                                            ...
                                            192,
                                            20,
                                            { componentTag: "MotionContextProvider" }
                                          );
                                                ...
                                                () => each(node_9, 1, () => get(_features), (feat) => feat.key, ($$anchor8, feat) => {
                                                  ...
                                                  add_svelte_meta(
                                                    () => component(node_10, () => get(feat).Component, ($$anchor9, $$component) => {
                                                      $$component($$anchor9, {
                                                        get props() {
                                                          return get(feat), untrack(() => get(feat).props);
                                                        },
                                                        get visualElement() {
                                                          return get(feat), untrack(() => get(feat).visualElement);
                                                        },
                                                        get isCustom() {
                                                          return isCustom;
                                                        }
          ...
          174,
          4,
          { componentTag: "UseCreateMotionContext" }
        );
        append($$anchor2, fragment_1);
      }),
      $$slots: { default: true }
    ...
    173,
    0,
    { componentTag: "ScaleCorrectionProvider" }
  );
  append($$anchor, fragment);
  var $$pop = pop($$exports);
  $$cleanup();
...
function UsePointerEvent($$anchor, $$props) {
  ...
  var node = first_child(fragment);
  {
    let $0 = derived_safe_equal(() => (deep_read_state(eventName()), untrack(() => getPointerEventName(eventName()))));
    let $1 = derived_safe_equal(() => (deep_read_state(handler()), deep_read_state(wrapHandler), deep_read_state(eventName()), untrack(() => handler() && wrapHandler(handler(), strict_equals(eventName(), "pointerdown")))));
    add_svelte_meta(
...
function UsePanGesture($$anchor, $$props) {
  ...
  function onPointerDown(event) {
    set(panSession, new PanSession(event, get(handlers), { transformPagePoint: get(transformPagePoint) }));
  }
  afterUpdate(() => {
  ...
  legacy_pre_effect(
    ...
    () => {
      (($$value) => {
        set(onPan, $$value.onPan);
        set(onPanStart, $$value.onPanStart);
        set(onPanEnd, $$value.onPanEnd);
        set(onPanSessionStart, $$value.onPanSessionStart);
      })(props());
    }
  );
  legacy_pre_effect(
  ...
  legacy_pre_effect(() => (get(transformPagePoint), $mcc()), () => {
    (($$value) => {
      set(transformPagePoint, $$value.transformPagePoint);
    })($mcc());
  });
  legacy_pre_effect(
  ...
  var node = first_child(fragment);
  {
    let $0 = derived_safe_equal(() => get(hasPanEvents) && onPointerDown);
    add_svelte_meta(
...
function UseTapGesture($$anchor, $$props) {
  ...
  legacy_pre_effect(
    ...
    () => {
      (($$value) => {
        set(onTap, $$value.onTap);
        set(onTapStart, $$value.onTapStart);
        set(onTapCancel, $$value.onTapCancel);
        set(whileTap, $$value.whileTap);
      })(props());
    }
  );
  legacy_pre_effect(
  ...
  var node = first_child(fragment);
  {
    let $0 = derived_safe_equal(() => get(hasPressListeners) ? onPointerDown : void 0);
    add_svelte_meta(
      () => UsePointerEvent_default(node, {
        get ref() {
          return visualElement2();
...
var root = add_locations(from_html(`<!> <!> <!>`, 1), UseHoverGesture[FILENAME], []);
function UseHoverGesture($$anchor, $$props) {
  ...
  legacy_pre_effect(
    ...
    () => {
      (($$value) => {
        set(onHoverStart, $$value.onHoverStart);
        set(onHoverEnd, $$value.onHoverEnd);
        set(whileHover, $$value.whileHover);
      })(props());
    }
  );
  legacy_pre_effect_reset();
  ...
  var node = first_child(fragment);
  {
    let $0 = derived_safe_equal(() => (get(onHoverStart), get(whileHover), deep_read_state(visualElement2()), untrack(() => get(onHoverStart) || get(whileHover) ? createHoverEvent(visualElement2(), true, get(onHoverStart)) : void 0)));
    add_svelte_meta(
      () => UsePointerEvent_default(node, {
        get ref() {
          return visualElement2();
  ...
  {
    let $0 = derived_safe_equal(() => (get(onHoverEnd), get(whileHover), deep_read_state(visualElement2()), untrack(() => get(onHoverEnd) || get(whileHover) ? createHoverEvent(visualElement2(), false, get(onHoverEnd)) : void 0)));
    add_svelte_meta(
...
function UseFocusGesture($$anchor, $$props) {
  ...
  legacy_pre_effect(() => (get(whileFocus), deep_read_state(props())), () => {
    (($$value) => {
      set(whileFocus, $$value.whileFocus);
    })(props());
  });
  legacy_pre_effect_reset();
  var $$exports = { ...legacy_api() };
  ...
  var node = first_child(fragment);
  {
    let $0 = derived_safe_equal(() => get(whileFocus) ? onFocus : void 0);
    add_svelte_meta(
      () => UseDomEvent_default(node, {
        get ref() {
          return visualElement2();
        ...
        children: wrap_snippet(UseFocusGesture, ($$anchor2, $$slotProps) => {
          ...
          var node_1 = first_child(fragment_1);
          {
            let $02 = derived_safe_equal(() => get(whileFocus) ? onBlur : void 0);
            add_svelte_meta(
...
var root2 = add_locations(from_html(`<!> <!> <!> <!> <!>`, 1), UseGestures[FILENAME], []);
...
function UseDrag($$anchor, $$props) {
  ...
  let tmp_1 = get2(mcc), transformPagePoint = mutable_source(tmp_1.transformPagePoint);
  dragControls.setProps({ ...props(), transformPagePoint: get(transformPagePoint) });
  onDestroy(() => {
    if (cleanup) {
      cleanup();
    }
  ...
  legacy_pre_effect(() => (get(groupDragControls), deep_read_state(props())), () => {
    (($$value) => {
      set(groupDragControls, $$value.dragControls);
    })(props());
  });
  legacy_pre_effect(() => (get(transformPagePoint), $mcc()), () => {
    (($$value) => {
  ...
  legacy_pre_effect(() => (deep_read_state(props()), get(transformPagePoint)), () => {
    dragControls.setProps({ ...props(), transformPagePoint: get(transformPagePoint) });
  });
  legacy_pre_effect(() => {
  }, () => {
...
function axisIsEqual(a2, b2) {
  return strict_equals(a2.min, b2.min) && strict_equals(a2.max, b2.max);
}
...
function Animate($$anchor, $$props) {
  ...
  onMount(() => {
    $$ownership_validator.mutation(null, ["visualElement", "animateMotionValue"], visualElement2(visualElement2().animateMotionValue = startAnimation, true), 134, 8);
    visualElement2().enableLayoutProjection();
    unsubLayoutReady = visualElement2().onLayoutUpdate(animateF);
    $$ownership_validator.mutation(
      null,
      ["visualElement", "layoutSafeToRemove"],
      visualElement2(
...
function AnimateLayoutContextProvider($$anchor, $$props) {
  ...
  legacy_pre_effect(() => (get(layout), deep_read_state(props())), () => {
    (($$value) => {
  ...
  add_svelte_meta(
    () => Animate_default(node, {
      ...
      get safeToRemove() {
        return $presence(), untrack(() => $presence()[1]);
      }
    }),
    "component",
...
function MeasureContextProvider($$anchor, $$props) {
  ...
  legacy_pre_effect(() => (get(update), deep_read_state(props())), () => {
    (($$value) => {
...
function AnimationState($$anchor, $$props) {
  ...
  let tmp = props(), animate3 = mutable_source(tmp.animate);
  legacy_pre_effect(() => (get(animate3), deep_read_state(props())), () => {
    (($$value) => {
      set(animate3, $$value.animate);
    })(props());
  });
  legacy_pre_effect(() => (deep_read_state(visualElement2()), createAnimationState), () => {
    $$ownership_validator.mutation(null, ["visualElement", "animationState"], visualElement2(visualElement2().animationState = visualElement2().animationState || createAnimationState(visualElement2()), true), 20, 8);
  });
  legacy_pre_effect(
    () => (isAnimationControls, get(animate3), tick, deep_read_state(visualElement2())),
    () => {
      if (isAnimationControls(get(animate3))) {
        tick().then(() => get(
          animate3
          /*, [animate]*/
...
function Exit($$anchor, $$props) {
  ...
  const effect = (pres) => {
    ...
    const animation = (_b = visualElement2().animationState) == null ? void 0 : _b.setActive(AnimationType.Exit, !isPresent2, { custom: ((_a = $presenceContext()) == null ? void 0 : _a.custom) ?? get(custom) });
    !isPresent2 && (animation == null ? void 0 : animation.then(onExitComplete));
    return "";
  };
  legacy_pre_effect(() => (get(custom), deep_read_state(props())), () => {
    (($$value) => {
          ...
          var node_1 = first_child(fragment_1);
          {
            ...
            element(
              ...
              ($$element, $$anchor3) => {
                ...
                attribute_effect($$element, () => ({ ...get(props) }));
                var fragment_2 = comment();
                var node_2 = first_child(fragment_2);
                slot(node_2, $$props, "default", {}, null);
                append($$anchor3, fragment_2);
...
var root_52 = add_locations(from_html(`<!> <!>`, 1), MotionSSR[FILENAME], []);
...
function AnimatePresence($$anchor, $$props) {
  ...
  legacy_pre_effect(() => (deep_read_state(list()), deep_read_state(show())), () => {
  ...
  legacy_pre_effect(() => (get(isl), $layoutContext(), get(_list)), () => {
    set(forceRender, () => {
      if (get(isl)) {
    ...
    () => {
      if (!get(isInitialRender)) {
        ...
        exiting.forEach((key) => {
          ...
          get(childrenToRender).splice(insertionIndex, 0, { present: false, item: child2, key: getChildKey(child2), onExit });
        });
  ...
  add_svelte_meta(
    () => each(node, 1, () => get(childrenToRender), (child2) => getChildKey(child2), ($$anchor2, child2) => {
      ...
      var node_1 = first_child(fragment_1);
      {
        let $0 = derived_safe_equal(() => initial() ? void 0 : false);
        let $1 = derived_safe_equal(() => (get(child2), deep_read_state(custom()), untrack(() => get(child2).onExit ? custom() : void 0)));
        add_svelte_meta(
          () => PresenceChild_default(node_1, {
            get isPresent() {
              return get(child2), untrack(() => get(child2).present);
            },
            get initial() {
              return get($0);
            },
            ...
            get onExitComplete() {
              return get(child2), untrack(() => get(child2).onExit);
            },
            get isCustom() {
              return isCustom();
            },
            children: wrap_snippet(AnimatePresence, ($$anchor3, $$slotProps) => {
              ...
              slot(
                ...
                {
                  get item() {
                    return get(child2), untrack(() => get(child2).item);
                  }
                },
                null
              );
...
function transform() {
  ...
  var interpolator = interpolate(inputRange, outputRange, Object.assign({ mixer: getMixer2(outputRange[0]) }, options));
...
var root_1 = add_locations(from_html(`<div><!></div>`), MotionDiv[FILENAME], [[7, 1]]);
    ...
    () => MotionSSR_default(node, spread_props(() => $$restProps, {
      ...
      $$slots: {
        default: ($$anchor2, $$slotProps) => {
          ...
          const props = derived_safe_equal(() => $$slotProps.props);
          var div_1 = root_1();
          attribute_effect(div_1, () => ({ ...get(props), ...div() }));
