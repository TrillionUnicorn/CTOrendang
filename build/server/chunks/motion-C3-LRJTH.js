import { f as sanitize_props, g as rest_props, j as store_get, u as unsubscribe_stores, k as bind_props, l as slot } from './index2-Bat9PaVJ.js';
import { w as writable, g as get, r as readable, d as derived } from './index-BUJd7wfk.js';
import { _ as fallback, Y as getContext, t as setContext, $ as ssr_context, a0 as invalid_default_snippet } from './context-_3h2dng2.js';
import 'clsx';
...
function UseVisualElement($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<!--[-->`);
    slot($$renderer2, $$props, "default", { visualElement: visualElement2 });
    $$renderer2.push(`<!--]-->`);
...
function UseFeatures($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    if (visualElement2) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<!--[-->`);
      slot($$renderer2, $$props, "default", { features });
      $$renderer2.push(`<!--]-->`);
    } else {
      $$renderer2.push("<!--[!-->");
    }
...
function UseInitialMotionValues($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    styles = memo();
    $$renderer2.push(`<!--[-->`);
    slot($$renderer2, $$props, "default", { styles });
    $$renderer2.push(`<!--]-->`);
...
function UseStyle($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    UseInitialMotionValues($$renderer2, {
      props,
      visualState,
      isStatic,
      children: invalid_default_snippet,
      $$slots: {
        default: ($$renderer3, { styles: s1 }) => {
          $$renderer3.push(`<!--[-->`);
          slot($$renderer3, $$props, "default", { styles: toStyle(s1) });
          $$renderer3.push(`<!--]-->`);
        }
      }
    });
...
function UseHTMLProps($$renderer, $$props) {
  ...
  UseStyle($$renderer, {
    ...
    children: invalid_default_snippet,
    $$slots: {
      default: ($$renderer2, { styles }) => {
        $$renderer2.push(`<!--[-->`);
        slot($$renderer2, $$props, "default", { visualProps: getHTMLProps(styles, props) });
        $$renderer2.push(`<!--]-->`);
      }
    }
  });
...
function UseSVGProps($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<!--[-->`);
    slot($$renderer2, $$props, "default", { visualProps });
    $$renderer2.push(`<!--]-->`);
...
function UseRender($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<!---->`);
    (Component === "SVG" ? UseSVGProps : UseHTMLProps)?.($$renderer2, {
      visualState,
      isStatic,
      props,
      children: invalid_default_snippet,
      $$slots: {
        default: ($$renderer3, { visualProps }) => {
          $$renderer3.push(`<!--[-->`);
          slot($$renderer3, $$props, "default", { motion: motion2, props: { ...filteredProps, ...visualProps } });
          $$renderer3.push(`<!--]-->`);
        }
      }
    });
...
function UseCreateMotionContext($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<!--[-->`);
    slot($$renderer2, $$props, "default", { value });
    $$renderer2.push(`<!--]-->`);
    if ($$store_subs) unsubscribe_stores($$store_subs);
...
function UseVisualState($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<!--[-->`);
    slot($$renderer2, $$props, "default", { state });
    $$renderer2.push(`<!--]-->`);
    if ($$store_subs) unsubscribe_stores($$store_subs);
...
function Motion($$renderer, $$props) {
  ...
  $$renderer.component(($$renderer2) => {
    ...
    ScaleCorrectionProvider($$renderer2, {
      isCustom,
      children: ($$renderer3) => {
        UseCreateMotionContext($$renderer3, {
          props: motionProps,
          isStatic,
          isCustom,
          children: invalid_default_snippet,
          $$slots: {
            default: ($$renderer4, { value: context }) => {
              UseVisualState($$renderer4, {
                ...
                children: invalid_default_snippet,
                $$slots: {
                  default: ($$renderer5, { state: visualState }) => {
                    UseVisualElement($$renderer5, {
                      Component,
                      visualState,
                      createVisualElement,
                      props: motionProps,
                      ...
                      children: invalid_default_snippet,
                      $$slots: {
                        default: ($$renderer6, { visualElement: visualElement2 }) => {
                          UseFeatures($$renderer6, {
                            visualElement: setContext2(context, visualElement2),
                            props: motionProps,
                            children: invalid_default_snippet,
                            $$slots: {
                              default: ($$renderer7, { features: _features }) => {
                                MotionContextProvider($$renderer7, {
                                  value: context,
                                  isCustom,
                                  children: ($$renderer8) => {
                                    UseRender($$renderer8, {
                                      ...
                                      children: invalid_default_snippet,
                                      $$slots: {
                                        default: ($$renderer9, { motion: motion2, props: renderProps }) => {
                                          $$renderer9.push(`<!--[-->`);
                                          slot($$renderer9, $$props, "default", { motion: motion2, props: renderProps });
                                          $$renderer9.push(`<!--]-->`);
                                        }
                                      }
                                    });
...
export { motion as m };
//# sourceMappingURL=motion-C3-LRJTH.js.map
